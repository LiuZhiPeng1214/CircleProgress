...
//    private int paddingStart = 10,paddingEnd = 0;
    ...
    //动画模式
    private final int ANIM_NULL = 0;         //无动画
    private final int ANIM_ROTATE = 1;         //旋转动画
    private final int ANIM_SCALE = 2;          //缩放
    private final int ANIM_ROTATE_SCALE = 3;     //旋转加缩放
    ...
    public PictureProgress(Context context, @Nullable AttributeSet attrs) throws Exception{
        super(context, attrs);
    ...
    public PictureProgress(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
